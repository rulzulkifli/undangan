...
export const guest = (() => {
  ...
  const buildGoogleCalendar = () => {
    ...
    const data = new URLSearchParams({
      action: "TEMPLATE",
      text: "The Wedding of Rul & Regita",
      // Rentang waktu dari Akad (10:00) sampai perkiraan selesai Resepsi (21:00)
      dates: `${formatDate("2026-04-12 10:00")}/${formatDate("2026-04-12 21:00")}`,
      details:
        "Tanpa mengurangi rasa hormat, kami mengundang Anda untuk berkenan menghadiri acara pernikahan kami.\n\n" +
        "AGENDA:\n" +
        "1. AKAD NIKAH (10.00 WITA): Jl. Abadi, Wowota, Kel. Mangolo (TOKO SATU TUJUH), Kec. Latambaga, Kab. Kolaka.\n" +
        "2. RESEPSI (19.00 WITA): Ballroom Lantai 1 Sutan Raja Hotel Kolaka, Jl. Khairil Anwar No. 1, Kel. Lamokato, Kolaka.\n\n" +
        "Terima kasih atas perhatian dan doa restu Anda.",
      location: "Sutan Raja Hotel Kolaka & Toko Satu Tujuh, Kolaka",
      ctz: "Asia/Makassar", // WITA
    });

    url.search = data.toString();

    // BARIS PENTING: Menghubungkan URL ke tombol "Save Google Calendar" di halaman Home
    document
